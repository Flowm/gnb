...
|           ; DATA XREF from 0x080489d0 (sym.__libc_csu_init)
|           0x08049850      55             push ebp
|           0x08049851      57             push edi
|           0x08049852      56             push esi
|           0x08049853      53             push ebx
|           0x08049854      e869000000     call sym.__i686.get_pc_thunk.bx
|           0x08049859      81c39b170000   add ebx, 0x179b
|           0x0804985f      83ec1c         sub esp, 0x1c
|           0x08049862      8b6c2430       mov ebp, dword [esp + 0x30] ; [0x30:4]=0x1b001e  ; '0'
|           0x08049866      8dbb18ffffff   lea edi, [ebx - 0xe8]
|           0x0804986c      e823efffff     call sym._init
|           0x08049871      8d8318ffffff   lea eax, [ebx - 0xe8]
|           0x08049877      29c7           sub edi, eax
|           0x08049879      c1ff02         sar edi, 2
|           0x0804987c      85ff           test edi, edi
|       ,=< 0x0804987e      7429           je 0x80498a9               
|       |   0x08049880      31f6           xor esi, esi
|       |   0x08049882      8db600000000   lea esi, [esi]
|       |   ; JMP XREF from 0x080498a7 (sym.finish_with_error)
|      .--> 0x08049888      8b442438       mov eax, dword [esp + 0x38] ; [0x38:4]=52 ; '8'
|      ||   0x0804988c      892c24         mov dword [esp], ebp
|      ||   0x0804988f      89442408       mov dword [esp + 8], eax
|      ||   0x08049893      8b442434       mov eax, dword [esp + 0x34] ; [0x34:4]=6 ; '4'
|      ||   0x08049897      89442404       mov dword [esp + 4], eax
|      ||   0x0804989b      ff94b318ffff.  call dword [ebx + esi*4 - 0xe8]
|      ||   0x080498a2      83c601         add esi, 1
|      ||   0x080498a5      39fe           cmp esi, edi
|      `==< 0x080498a7      75df           jne 0x8049888              
|       |   ; JMP XREF from 0x0804987e (sym.finish_with_error)
|       `-> 0x080498a9      83c41c         add esp, 0x1c
|           0x080498ac      5b             pop ebx
|           0x080498ad      5e             pop esi
|           0x080498ae      5f             pop edi
|           0x080498af      5d             pop ebp
\           0x080498b0      c3             ret
