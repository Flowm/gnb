...
\begin{description}
	\item[PHP Code(RIPS,RAPS)] Both RIPS and RAPS were used in grading the quality of the PHP code for both applications \bs and \gnb, and while RIPS was slightly better in providing more substantial insights, both were significantly high on false positives which makes using them slightly impractical for enterprise applications.
\end{description}
