...
\vultable{\doge}{%
	...
	Relevant information leakage resulting from the unencrypted communication has already been covered in section~\ref{vuln:OTG-CONFIG-007}
}{%
	\na
}{%
	\na
...
\vultable{\doge}{%
	As the application is only accessible via HTTP and no SSL/TLS encryption is
	used, sensitive information is sent over unencrypted channels in every
