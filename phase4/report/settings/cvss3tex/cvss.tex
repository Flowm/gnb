...
\newcommand{\calculateCVSSScopeUnchanged}[2]{%
    ...
    \FPclip\calculateCVSSScopeUnchangedResult\calculateCVSSScopeUnchangedResult%
}
...
\newcommand{\calculateCVSSScopeChanged}[2]{%
    ...
    \FPclip\calculateCVSSScopeChangedResult\calculateCVSSScopeChangedResult%
}
