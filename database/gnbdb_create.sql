...
-- Mon 02 Nov 2015 10:20:55 PM CET
...
SELECT
    ...
    IF (
		...
		1000000,		# balance is 1 million
			SUM(		# else calculate sum
				IF (
					T.status = 2 OR (T.status = 0 AND A.id = T.destination_account_id),	# if rejected transaction or unapproved for destination
